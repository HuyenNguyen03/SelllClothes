							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th>Category Name</th>
										<th style="width: 200px;">Category Sum</th>
										<th style="width: 100px;">Category Count</th>
							...
							<div class="col border-0">
								<div class=" col btn-group" role="group">
									<button type="button" class="btn border">
										<a href="/admin/reportcategory?p=0">First</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/reportcategory?p=${page.number-1}">Previous</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/reportcategory?p=${page.number+1}">Next</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/reportcategory?p=${page.totalPages-1}">Last</a>
									</button>
								</div>
							</div>
							<div class="col">
