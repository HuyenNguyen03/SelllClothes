...
<link rel="stylesheet" type="text/css"
	href="/forUser/styles/categories_styles.css">
<link rel="stylesheet" type="text/css"
	href="/forUser/styles/categories_responsive.css">

<link href="/forUser/styles/range.css" rel="stylesheet" type="text/css">
</head>
<body>
					...
					<div class="sidebar">
						...
						<form action="/home/price" method="post">
							<div class="sidebar_section">
								...
								<!-- 										<div> -->
								<!-- 											<p class="rangePrice" id="max-value">$500</p> -->
								<!-- 										</div> -->
								<!-- 									</div> -->

								<!-- 									<div class="range-slider"> -->
								<!-- 										<input type="range" class="min-price" value="10" min="0" -->
								<!-- 											max="1000" step="10"> <input type="range" -->
								<!-- 											class="max-price" value="250" min="0" max="1000" step="10"> -->
								<!-- 									</div> -->
								...
								<div class="range-slider">
									<input type="range" class="min-price" value="10" min="0"
										max="1000" step="10" name="min" id="minamount">
										 <input type="range"
										class="max-price" value="250" min="0" max="1000" step="10" name="max" id="maxamount">
								</div>
	...
	<script src="/forUser/js/categories_custom.js"></script>
	<script src="/forUser/js/script.js"></script>
</body>
</html>