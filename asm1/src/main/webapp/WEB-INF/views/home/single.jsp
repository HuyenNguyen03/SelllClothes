...
<link rel="stylesheet"
	href="/forUser/plugins/themify-icons/themify-icons.css">
<link rel="stylesheet" type="text/css"
	href="/forUser/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
<link rel="stylesheet" type="text/css"
	href="/forUser/styles/single_styles.css">
<link rel="stylesheet" type="text/css"
	href="/forUser/styles/single_responsive.css">
</head>
<body>
			...
			<div class="row">
						...
						<div class="row">
							<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
								<div class="single_product_thumbnails">
									<ul>
										<li><img src="/forUser/images/single_1_thumb.jpg" alt=""
											data-image="/forUser/images/single_1.jpg"></li>
										<li class="active"><img
											src="/forUser/images/single_2_thumb.jpg" alt=""
											data-image="/forUser/images/single_2.jpg"></li>
										<li><img src="/forUser/images/single_3_thumb.jpg" alt=""
											data-image="/forUser/images/single_3.jpg"></li>
									</ul>
								</div>
							</div>
							<div class="col-lg-9 image_col order-lg-2 order-1">
								<div class="single_product_image">
									<div class="single_product_image_background"
										style="background-image:url( /forUser/images/${pr.image})"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-5">
					<div class="product_details">
						...
						<div class="original_price">$495.00</div>
						...
						<div
							...
							<div class="add_button add_to_cart">
																<a href="/home/cart/add/${pr.id }">add to cart</a>
						...
						<div id="tab_1" class="tab_container active">
							<div class="row">
								<div class="col-lg-5 desc_col">
									...
									<div class="tab_image">
										<img src="/forUser/images/${pr.image}" alt="">
									</div>
									<div class="tab_text_block">
										<h2>Pocket cotton sweatshirt</h2>
										<p>Nam tempus turpis at metus scelerisque placerat nulla
								...
								<div class="col-lg-5 offset-lg-2 desc_col">
									<div class="tab_image">
										<img src="/forUser/images/desc_2.jpg" alt="">
									</div>
									<div class="tab_text_block">
										<h2>Pocket cotton sweatshirt</h2>
										<p>Nam tempus turpis at metus scelerisque placerat nulla
									...
									<div class="tab_image desc_last">
										<img src="/forUser/images/desc_3.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
	...
	<script src="/forUser/js/single_custom.js"></script>
</body>
</html>