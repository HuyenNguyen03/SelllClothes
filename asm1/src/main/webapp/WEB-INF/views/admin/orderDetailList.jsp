...
<!-- 									</button> -->
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										<th style="width: 80px;">OrderDetail</th>
										<th style="width: 120px;">Product Img</th>
							...
							<div class="col border-0">
								<div class=" col btn-group" role="group">
									<button type="button" class="btn border">
										<a href="/admin/orderDetail?p=0">First</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/orderDetail?p=${page.number-1}">Previous</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/orderDetail?p=${page.number+1}">Next</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/orderDetail?p=${page.totalPages-1}">Last</a>
									</button>
								</div>
							</div>
							<div class="col">
