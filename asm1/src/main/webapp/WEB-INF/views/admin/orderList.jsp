							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th>Address</th>
										<th style="width: 200px;">Order Detail</th>
										<th>Action</th>
									</tr>
								</thead>
								<tbody>
									...
									style="font-size: 14px">Order Detail</a></td>
											<td>
													<a href="order/delete/${item.id}" class="delete"
							...
							<div class="col border-0">
								<div class=" col btn-group" role="group">
									<button type="button" class="btn border">
										<a href="/admin/order?p=0">First</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/order?p=${page.number-1}">Previous</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/order?p=${page.number+1}">Next</a>
									</button>
									<button type="button" class="btn border">
										<a href="/admin/order?p=${page.totalPages-1}">Last</a>
									</button>
								</div>
							</div>
							<div class="col">
