							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<c:forEach var="item" items="${page.content}">
										<tr>
											<td><img
												src="/forAdmin/assets/images/users/${item.photo}" alt=""
												width="90%" class="img-fluid"></td>
											<td>${item.username}</td>
											<td>${item.password}</td>
											<td>${item.fullname}</td>
											<td>${item.email}</td>
											...
											<td>${item.admin}</td>
											<td><a href="account/edit/${item.username}" class="edit" title="Edit" data-toggle="tooltip"><i
													class="material-icons">&#xE254;</i></a> 
													<a href="account/delete/${item.username}" class="delete"
