							...
							<div class="row">
								...
								<div class="col-sm-4">
									<button type="button" class="btn btn-info add-new">
										<a href="categoryControl" ><i class="fa fa-plus"></i>Add
						New Category</a>
									</button>
								</div>
							</div>
								...
								<tbody>
									<c:forEach var="item" items="${page.content}">
										<tr class="text-center">
											...
											<td>${item.id}</td>
											<td>${item.name}</td>
											<td><a href="category/edit/${item.id}" title="Edit" data-toggle="tooltip"><i
													class="material-icons">&#xE254;</i></a> 
													<a href="category/delete/${item.id}" class="delete"
						...
						<div class="row">
							...
							<div class="col border-0">
								<div class=" col btn-group" role="group">
									...
									<button type="button" class="btn border">
										<a href="/admin/category?p=${page.number+1}">Next</a>
									</button>
									<button type="button" class="btn border">
